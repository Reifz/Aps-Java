...
public class SignUp extends javax.swing.JFrame {
    ...
    private void SignUpbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SignUpbtnActionPerformed
       ...
       Connecting conn = new Connecting("3307","mydb", "root", "");
       
       
       try{
       //conexão 
       Class.forName("com.mysql.cj.jdbc.Driver");
       Connection con = DriverManager.getConnection(conn.get$Url(),conn.get$Username(),conn.get$Pwd());
       ...
       }else if("".equals(password.getText()))
       {
           ...
           p1.setName(fname.getText());
           p1.setEmail(emailAddress.getText());
           p1.setPwd(password.getText());
           
           
           query = "INSERT INTO login(email,pwd,fullname)" + "VALUES('"+p1.getEmail()+"','"+p1.getPwd()+"','"+p1.getName()+"')";
           st.execute(query);
           fname.setText("");
